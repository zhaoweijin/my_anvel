...
(function () {
    ...
    var tmp = window.location.pathname;
        ...
        var ueditor_path = "resource/common/UEditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:web_root + "admin.php?m=UEditor&a=imageUp"   //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                              //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:web_root + "admin.php?m=UEditor&a=scrawlUp" //涂鸦上传地址
        ,scrawlPath:""                           //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:web_root + "admin.php?m=UEditor&a=fileUp"    //附件上传提交地址
        ,filePath:""                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:web_root + "admin.php?m=UEditor&a=getRemoteImage"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:web_root + "admin.php?m=UEditor&a=imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:""                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: host                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: web_root + "admin.php?m=UEditor&a=imageUp" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath:""
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: 'center'                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:web_root + "admin.php?m=UEditor&a=imageUp"       //word转存提交地址
        ,wordImagePath:""                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        ,getMovieUrl:web_root + "admin.php?m=UEditor&a=getMovie"                   //视频数据获取地址
